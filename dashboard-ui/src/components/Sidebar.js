  ...
  return (
    <aside className="sidebar">
      <div className="nav-logo">
        ...
        Link<span className="text-gradient">Place</span>
      </div>
      ...
      <div className="nav-group">
        ...
        <Link href="/tool" className={`nav-item ${pathname === '/tool' ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
          Find Placement
        </Link>
        <div className="nav-item disabled" style={{ cursor: 'not-allowed', opacity: 0.6 }}>
      ...
      <div className="nav-group">
        <div className="nav-label">Subscription</div>
        <Link href="/plans" className={`nav-item ${pathname === '/plans' ? 'active' : ''}`}>
