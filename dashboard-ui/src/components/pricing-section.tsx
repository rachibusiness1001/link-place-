    ...
    <section className="relative py-16 md:py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-[80px] md:leading-[90px] font-bold bg-gradient-to-r from-white via-white to-white/60 bg-clip-text text-transparent mb-8">
            Choose your plan
          </h2>
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, featureIndex) => (
                  <li key={featureIndex} className="flex items-center gap-4">
                    <Check className="w-6 h-6 text-[#e78a53] flex-shrink-0" />
