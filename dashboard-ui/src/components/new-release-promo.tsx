...
export function NewReleasePromo() {
  return (
    <section className="mt-24 md:mt-32 mb-32 w-full">
      <div className="mx-auto max-w-6xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[500px] max-w-6xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-12 text-center">
              <h2 className="text-5xl md:text-6xl font-bold text-white mb-6">Build. Customize. Deploy Quickly.</h2>
              <p className="text-xl md:text-2xl text-white/60 mb-10">Built to keep you hooked.</p>
              <svg
                width="150"
                height="75"
                viewBox="0 0 100 50"
            ...
            <h1
              className="absolute inset-x-0 mt-[160px] text-center text-[100px] font-semibold text-transparent sm:mt-[60px] sm:text-[240px] pointer-events-none"
              style={{
            ...
            <h1
              className="absolute inset-x-0 mt-[160px] text-center text-[100px] font-semibold text-primary sm:mt-[60px] sm:text-[240px] pointer-events-none"
              aria-hidden="true"
            >
              skiper/ui
            </h1>
