...
export default function Hero() {
  ...
  const botY = useTransform(scrollY, [0, 800], [0, 200])
  ...
  return (
    <>
      <section className="relative overflow-hidden flex flex-col min-h-[80vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0 overflow-hidden mt-[-5%] w-full">
          <span className="text-[12vw] 2xl:text-[200px] font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-zinc-800/80 to-transparent whitespace-nowrap opacity-60 w-full text-center">
            MY LINK PLACE
          </span>
        </div>
        ...
        <div className="container mx-auto px-4 pt-32 pb-12 sm:pt-40 sm:pb-16 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-[4.5rem] leading-[1.1] max-w-4xl mx-auto">
                The right backlink starts with the right placement. We help you find both.
              </h1>
            </motion.div>
            ...
            <motion.p
              ...
              className="mx-auto mb-12 max-w-2xl text-lg sm:text-xl text-muted-foreground leading-relaxed"
            >
              Find relevant link placement opportunities, discover high-quality SaaS websites, and build backlinks that actually make an impact.
            </motion.p>
