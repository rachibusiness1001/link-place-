  ...
  return (
    <section id="features" className="text-foreground relative overflow-hidden py-24 sm:py-32 md:py-48">
      ...
      >
        <h2
          className={cn(
            "via-foreground mb-12 bg-gradient-to-b from-zinc-800 to-zinc-700 bg-clip-text text-center text-5xl font-semibold tracking-tighter text-transparent md:text-[80px] md:leading-[90px]",
            geist.className,
          )}
        >
          Features
        ...
        >
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 justify-center">
              {/* Cli */}
              <motion.div
                className="group border-secondary/40 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-10 shadow-xl transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-2"
              ...
              >
                <div className="flex flex-col gap-6">
                  <h3 className="text-3xl sm:text-4xl leading-none font-bold tracking-tight">CLI & Manual Support</h3>
                  <div className="text-muted-foreground flex flex-col gap-2 text-lg sm:text-xl">
              ...
              {/* Global */}
              <motion.div
                className="group border-secondary/40 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-10 shadow-xl transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-8"
              ...
              >
                <div className="flex flex-col gap-6">
                  <h3 className="text-3xl sm:text-4xl leading-none font-bold tracking-tight">Globally Usable</h3>
                  <div className="text-muted-foreground flex flex-col gap-2 text-lg sm:text-xl">
                    <p className="max-w-[460px]">
              ...
              >
                <div className="flex flex-col gap-6">
                  <h3 className="text-3xl sm:text-4xl leading-none font-bold tracking-tight">Smart Components</h3>
                  <div className="text-muted-foreground flex flex-col gap-2 text-lg sm:text-xl">
                    <p className="max-w-[460px]">
                ...
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="w-full max-w-lg">
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      ...
                      {/* Animated Cursor for Smart Components */}
                      <motion.div
                        className="absolute z-50 pointer-events-none"
                        initial={{ x: 250, y: 150, opacity: 0 }}
                        animate={{
                          x: [250, 50, 50, 320, 320, 250],
                          y: [150, 50, 50, 120, 120, 150],
                          opacity: [0, 1, 1, 1, 1, 0]
                        }}
                        transition={{
                          duration: 6,
                      ...
                      >
                        ...
                        >
                          <path d="M5.5 3.21V20.8C5.5 21.46 6.3 21.79 6.77 21.32L11.5 16.59C11.69 16.4 11.94 16.3 12.21 16.3H20.79C21.45 16.3 21.78 15.5 21.31 15.03L5.5 3.21Z" fill="white" stroke="black" strokeWidth="1.5" strokeLinejoin="round"/>
                        </svg>
                      </motion.div>
              ...
              >
                <div className="flex flex-col gap-6">
                  <h3 className="text-3xl sm:text-4xl leading-none font-bold tracking-tight">Dynamic Layouts</h3>
                  <div className="text-muted-foreground flex flex-col gap-2 text-lg sm:text-xl">
                    <p className="max-w-[460px]">
